...
const FeatureList = [
  ...
  },
  {
    ...
    description: (
      <>
        It provides users with the capability to access the ESPN API’s
        NBA game play-by-plays, box scores, and schedules to analyze the data for themselves.
      </>
    ),
  },
];
...
export default function Home() {
  ...
  return (
    <Layout
      ...
      description="The SportsDataverse's R Package for Men's Basketball Data.">
      <HomepageHeader />
      <main>
