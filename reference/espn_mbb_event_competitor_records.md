...
``` r
espn_mbb_event_competitor_records(event_id, team_id, ...)
```
...
#> ✖ 2026-05-19 17:29:29.959381: Failed to retrieve ESPN mens-college-basketball competitor records for event_id=401812680, team_id=150
