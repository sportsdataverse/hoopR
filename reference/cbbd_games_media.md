...
#> ✖ 2026-08-26 19:54:16.680991: Invalid arguments or no games data available!
...
#> ✖ 2026-08-26 19:54:16.691228: Invalid arguments or no game media available!
...
#> ✖ 2026-08-26 19:54:16.7013: Invalid arguments or no team box score data available!
#> ✖ Args: season = 2024, season_type = NULL, team = "Duke", conference = NULL, start_date_range = NULL, end_date_range = NULL, tournament = NULL
#> ✖ Error: api.collegebasketballdata.com requires an API key.        See ?register_cbbd for details.
#> data frame with 0 columns and 0 rows
# }
...
#> ✖ 2026-08-26 19:54:16.711243: Invalid arguments or no player box score data available!
#> ✖ Args: season = 2024, season_type = NULL, team = "Duke", conference = NULL, start_date_range = NULL, end_date_range = NULL, tournament = NULL
#> ✖ Error: api.collegebasketballdata.com requires an API key.        See ?register_cbbd for details.
#> data frame with 0 columns and 0 rows
# }
...
#> ✖ 2026-08-26 19:54:16.721237: Invalid arguments or no scoreboard data available!
#> ✖ Args: conference = "ACC"
#> ✖ Error: api.collegebasketballdata.com requires an API key.        See ?register_cbbd for details.
#> data frame with 0 columns and 0 rows
# }
