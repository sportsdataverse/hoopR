...
``` r
espn_mbb_event_probabilities(event_id, limit = 200, ...)
```
...
#> ✖ 2026-05-17 16:23:53.138297: Failed to retrieve ESPN mens-college-basketball event probabilities for event_id=401735229
