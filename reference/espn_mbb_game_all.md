...
#> ℹ Data updated: 2026-08-25 02:47:10 UTC
#> # A tibble: 360 × 53
...
#> ℹ Data updated: 2026-08-25 02:47:11 UTC
#> # A tibble: 30 × 54
...
#> ── ESPN MBB Play-by-Play Information from ESPN.com ────────────── hoopR 3.1.0 ──
#> ℹ Data updated: 2026-08-25 02:47:12 UTC
#> # A tibble: 360 × 53
#>    id       sequence_number text  away_score home_score scoring_play score_value
#>    <chr>    <chr>           <chr>      <int>      <int> <lgl>              <int>
#>  1 4014796… 101799901       Jump…          0          0 FALSE                  0
...
#> ℹ Data updated: 2026-08-25 02:47:14 UTC
#> # A tibble: 34 × 151
...
#> ℹ Data updated: 2026-08-25 02:47:15 UTC
#> # A tibble: 472 × 54
#>    id       sequence_number text  away_score home_score scoring_play score_value
#>    <chr>    <chr>           <chr>      <int>      <int> <lgl>              <int>
...
#> ── ESPN NBA Play-by-Play Information from ESPN.com ────────────── hoopR 3.1.0 ──
#> ℹ Data updated: 2026-08-25 02:47:16 UTC
#> # A tibble: 475 × 54
#>    id       sequence_number text  away_score home_score scoring_play score_value
#>    <chr>    <chr>           <chr>      <int>      <int> <lgl>              <int>
...
#> ── ESPN NBA Team Box Information from ESPN.com ────────────────── hoopR 3.1.0 ──
#> ℹ Data updated: 2026-08-25 02:47:17 UTC
#> # A tibble: 2 × 57
#>     game_id season season_type game_date  game_date_time      team_id team_uid  
#>       <int>  <int>       <int> <date>     <dttm>                <int> <chr>     
...
#> ✖ 2026-08-25 02:47:17.923274: Invalid arguments or no game roster data for 401283399 available!
...
#> ℹ Data updated: 2026-08-25 02:47:18 UTC
#> # A tibble: 3 × 66
#>   details over_under spread over_odds under_odds provider_id provider_name
