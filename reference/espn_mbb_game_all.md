...
#> ℹ Data updated: 2026-08-27 17:46:53 UTC
#> # A tibble: 360 × 53
...
#> ℹ Data updated: 2026-08-27 17:46:54 UTC
#> # A tibble: 2 × 57
...
#> ── ESPN MBB Play-by-Play Information from ESPN.com ────────────── hoopR 3.1.0 ──
#> ℹ Data updated: 2026-08-27 17:46:55 UTC
#> # A tibble: 360 × 53
#>    id       sequence_number text  away_score home_score scoring_play score_value
#>    <chr>    <chr>           <chr>      <int>      <int> <lgl>              <int>
#>  1 4014796… 101799901       Jump…          0          0 FALSE                  0
...
#> ℹ Data updated: 2026-08-27 17:46:56 UTC
#> # A tibble: 34 × 151
...
#> ℹ Data updated: 2026-08-27 17:46:57 UTC
#> # A tibble: 3 × 66
...
#> ℹ Data updated: 2026-08-27 17:46:58 UTC
#> # A tibble: 472 × 54
#>    id       sequence_number text  away_score home_score scoring_play score_value
#>    <chr>    <chr>           <chr>      <int>      <int> <lgl>              <int>
...
#> ── ESPN NBA Play-by-Play Information from ESPN.com ────────────── hoopR 3.1.0 ──
#> ℹ Data updated: 2026-08-27 17:46:59 UTC
#> # A tibble: 475 × 54
#>    id       sequence_number text  away_score home_score scoring_play score_value
#>    <chr>    <chr>           <chr>      <int>      <int> <lgl>              <int>
...
#> ── ESPN NBA Player Box Information from ESPN.com ──────────────── hoopR 3.1.0 ──
#> ℹ Data updated: 2026-08-27 17:47:00 UTC
#> # A tibble: 26 × 57
#>      game_id season season_type game_date  game_date_time      athlete_id
#>        <int>  <int>       <int> <date>     <dttm>                   <int>
...
#> ✖ 2026-08-27 17:47:00.577868: Invalid arguments or no game roster data for 401283399 available!
