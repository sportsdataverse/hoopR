...
``` r
espn_mbb_athlete_seasons(athlete_id, ...)
```
...
# \donttest{
  ...
  espn_mbb_athlete_seasons(athlete_id = 4593919)
#> ✖ 2026-05-30 18:38:32.982415: Failed to retrieve ESPN mens-college-basketball athlete seasons for athlete_id=4593919
