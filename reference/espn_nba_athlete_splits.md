...
``` r
espn_nba_athlete_splits(athlete_id, season = most_recent_nba_season(), ...)
```
...
#> ✖ 2026-05-19 00:23:50.655677: Failed to retrieve ESPN nba athlete splits for athlete_id=3149391, season=2024
