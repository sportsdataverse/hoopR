...
``` r
espn_mbb_event_play(event_id, play_id, ...)
```
...
#> ✖ 2026-05-19 17:29:32.219069: Failed to retrieve ESPN mens-college-basketball event play detail for event_id=401283399, play_id=4012833997
