...
``` r
espn_nba_athlete_gamelog(athlete_id, season = most_recent_nba_season(), ...)
```
...
#> ✖ 2026-05-19 01:33:41.171566: Failed to retrieve ESPN nba athlete gamelog for athlete_id=3149391, season=2024
