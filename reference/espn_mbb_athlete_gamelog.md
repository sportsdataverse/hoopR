...
``` r
espn_mbb_athlete_gamelog(athlete_id, season = most_recent_mbb_season(), ...)
```
...
#> ✖ 2026-05-19 00:23:05.446946: Failed to retrieve ESPN mens-college-basketball athlete gamelog for athlete_id=4433985, season=2025
