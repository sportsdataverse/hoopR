...
[espn_mbb_player_seasons_schema](https://hoopR.sportsdataverse.org/reference/espn_mbb_player_seasons_schema.md)
table.
...
#> ✖ 2026-08-25 01:41:13.044854: Failed to retrieve ESPN mens-college-basketball athlete seasons for athlete_id=4593919
#> ✖ Args: league = "mens-college-basketball", athlete_id = 4593919
#> ✖ Error: The API returned an error
#> ── ESPN MENS-COLLEGE-BASKETBALL Athlete Seasons ───────────────── hoopR 3.1.0 ──
#> ℹ Data updated: 2026-08-25 01:41:13 UTC
#> # A tibble: 0 × 0
# }
```
