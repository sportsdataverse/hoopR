...
``` r
espn_mbb_athlete_splits(athlete_id, season = most_recent_mbb_season(), ...)
```
...
#> ✖ 2026-05-18 16:28:16.534078: Failed to retrieve ESPN mens-college-basketball athlete splits for athlete_id=4433985, season=2025
