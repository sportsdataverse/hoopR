...
[espn_mbb_week_ranking_schema](https://hoopR.sportsdataverse.org/reference/espn_mbb_week_ranking_schema.md)
table.
...
#> ✖ 2026-08-24 20:40:35.398114: Failed to retrieve ESPN nba week-5 ranking 1 for season=2025
#> ✖ Args: league = "nba", season = 2025, season_type = 2L, week = 5, ranking_id = 1
#> ✖ Error: The API returned an error
#> ── ESPN NBA Week Ranking Detail ───────────────────────────────── hoopR 3.1.0 ──
#> ℹ Data updated: 2026-08-24 20:40:35 UTC
#> # A tibble: 0 × 0
# }
```
