...
``` r
espn_mbb_athlete_stats(athlete_id, season = most_recent_mbb_season(), ...)
```
...
#> ✖ 2026-05-18 22:39:58.052462: Failed to retrieve ESPN mens-college-basketball athlete stats for athlete_id=4433985, season=2025
