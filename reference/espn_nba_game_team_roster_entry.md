...
# \donttest{
  espn_nba_game_team_roster_entry(event_id = 401283399,
                                            team_id = 13,
                                            athlete_id = 1966)
#> ✖ 2026-06-12 03:15:14.665222: Failed to retrieve ESPN nba event roster entry for event_id=401283399, team_id=13, athlete_id=1966
#> ✖ Args: league = "nba", event_id = 401283399, team_id = 13, athlete_id = 1966
#> ✖ Error: The API returned an error
#> ── ESPN NBA Event Competitor Roster Entry ─────────────────────── hoopR 3.1.0 ──
#> ℹ Data updated: 2026-06-12 03:15:14 UTC
#> # A tibble: 0 × 0
# }
```
