...
freshly pulled from ESPN and NBA.com. A handful -- bulk season
downloads, the database recipe, and the proxy examples -- are shown but
not run, since they either take too long or would reconfigure your
session; those are flagged where they appear.
