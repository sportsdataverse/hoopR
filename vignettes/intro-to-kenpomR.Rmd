...
For .Renviron, save that information in a format like this:
...
Let's first just try to get our hands on the Pomeroy ratings for the last 10 years by using the ```kenpomR::get_pomeroy_ratings()``` function, which takes the following arguments:
