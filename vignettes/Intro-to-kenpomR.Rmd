...
You can use your .Renviron to save your `kp_user` and `kp_pw` variables, or you can simply set them using `Sys.setenv()` like so:

```{r eval = FALSE}
Sys.setenv(kp_user = "Your Username Here")
