...
draw_frame <- function(year)
{
  ...
  frm_plot <- frm_data %>% 
    ...
    geom_image(aes(x = Year, y = Metric_1, image = frm_data$logo_1),  size = .03, asp = 1.5)+
    geom_image(aes(x = Year, y = Metric_2, image = frm_data$logo_2),  size = .06, asp = 1.5)+
    annotation_custom(grob = rast, xmin=2017, xmax=2020, ymin=-2, ymax=-20)+
    geom_line(aes(color = Color1, x = Year, y = Metric_1), size = 1)+
    geom_line(aes(color = Color2, x = Year, y = Metric_2), size = 1)+
