...
rtgs <- kp_pomeroy_ratings(min_year = 2010, max_year = 2021)
```
...
effs <- kp_efficiency(min_year = 2021, max_year = 2021)
glimpse(effs)
```

```{r kp_fourfactors_ex, message = FALSE}

ff <-  kp_fourfactors(min_year = 2021, max_year = 2021)
glimpse(ff)
```

```{r kp_hgts, message = FALSE}

hgts <-  kp_height(min_year = 2021, max_year = 2021)
...
plyrstats <- kp_team_player_stats(team = 'Florida St.', year = 2021)
