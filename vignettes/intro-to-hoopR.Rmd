...
opengraph:
  image: 
    src: "https://github.com/sportsdataverse/hoopR-data/blob/master/themes/hoopR_gh.png?raw=true"
  twitter:
...
![Result](https://github.com/sportsdataverse/hoopR/blob/master/man/figures/animated_adj_em.gif?raw=true)
