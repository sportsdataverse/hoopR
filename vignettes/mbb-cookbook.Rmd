...
College players turn over fast, so you'll usually start from the team
roster (Recipe 1) to grab an `athlete_id`, then walk the athlete family:

```{r}
athlete_id <- 4593919   # a recent Duke freshman
...
espn_mbb_standings(season = season)
