...
```
    ...
    ## 3604496 rows of nba play-by-play data from 7655 games.
...
```
    ...
    ## 15210 rows of NBA team boxscore data from 7605 games.
...
```
    ...
    ## 201172 rows of NBA player boxscore data from 7656 games.
