...
```
    ...
    ## 3606112 rows of nba play-by-play data from 7658 games.
...
```
    ...
    ## 15216 rows of NBA team boxscore data from 7608 games.
...
```
    ...
    ## 201258 rows of NBA player boxscore data from 7659 games.
