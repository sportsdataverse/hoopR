...
```
    ...
    ## 3609607 rows of nba play-by-play data from 7665 games.
...
```
    ...
    ## 15230 rows of NBA team boxscore data from 7615 games.
...
```
    ...
    ## 201457 rows of NBA player boxscore data from 7666 games.
