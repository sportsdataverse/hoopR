...
```
    ...
    ## 3605075 rows of nba play-by-play data from 7656 games.
...
```
    ...
    ## 15212 rows of NBA team boxscore data from 7606 games.
...
```
    ...
    ## 201199 rows of NBA player boxscore data from 7657 games.
