...
#' `espn_mbb_calendar()` (league = "mens-college-basketball") and
#' `espn_nba_calendar()` (league = "nba"). The scoreboard endpoint carries a
...
.espn_basketball_calendar <- function(league, season, ...) {
  ...
  tryCatch(
    expr = {
      ...
      #       common shape for both MBB and NBA scoreboards in 2025+.
