...
# Internal helpers shared by MBB and NBA franchise wrappers.
...
.espn_basketball_franchise <- function(league, franchise_id, ...) {
  ...
  result <- .empty_hoopR_data(paste0("ESPN ", toupper(league), " Franchise from ESPN.com"))
...
#' the IDs to `.espn_basketball_franchise()` to get full details.
#'
...
.espn_basketball_franchises <- function(league, ...) {
  ...
  result <- .empty_hoopR_data(paste0("ESPN ", toupper(league), " Franchises Index"))
